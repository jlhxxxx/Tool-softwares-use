...
参考式的链接是在链接文字的括号后面再接上另一个方括号，而在第二个方括号里面要填入用以辨识链接的标记，在文件的任意处，你可以把这个标记的链接内容定义出来：
    ...
    I get 10 times more traffic from [Google][] than from [Yahoo][] or [MSN][]（隐式链接）.
...
参考式的图片语法则长得像这样：
    ...
    [id]: https://pic4.zhimg.com/d5422732754a69792853b6028f2a75df_b.png  "Optional title attribute"
